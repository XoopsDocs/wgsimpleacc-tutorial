...
![List of balances](../../.gitbook/assets/en_balances.png)

You can display the details for each balance where you can see the calculation for each asset.

![Details of balance](../../.gitbook/assets/en_balances_detail.png)
...
![Creation of new balance](../../.gitbook/assets/en_balances_create.png)

If you click on "Pre-calculate" you get a calculation for the assets for selected period.

![Creation of new balance](../../.gitbook/assets/en_balances_calc.png)
